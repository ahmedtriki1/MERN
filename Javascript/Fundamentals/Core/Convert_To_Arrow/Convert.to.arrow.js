...
<body id="body">
    ...
    <p onclick="setBackgroundColorById('ccouleur',getValueFromId('iinput'))" id="ccouleur">
        Another task: This should be another feature. 
        I want to click anywhere in this paragraph tag and I want to be able to change the background color to whatever is in this input: <input id="iinput" type="text"/>.
    </p>
    <script>
